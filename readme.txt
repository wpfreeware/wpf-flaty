...
This is a free WordPress theme from WpFreeware.com. WpF Flaty designed especially flat technology in mind. 
If you are looking for a flat design WordPress theme then this theme is perfect for you. 
It's completely responsive, packed with left/right sidebar, fullwidth template, pre-designed widgets & lots more.
...
Images used in screenshot.png were picked from https://www.pexels.com. 
...
Fonts :
======================
WpF Flaty packed with 3 differnt google fonts (SansPro, Raleway, Lobster) which are mentioned below with their license url.

1. Source Sans Pro
Link : https://www.google.com/fonts/specimen/Source+Sans+Pro
SIL Open Font Licence 1.1 http://scripts.sil.org/cms/scripts/page.php?site_id=nrsi&id=OFL

2.Raleway

Link : https://www.google.com/fonts/specimen/Raleway
SIL Open Font Licence 1.1 http://scripts.sil.org/cms/scripts/page.php?site_id=nrsi&id=OFL

3.Lobster

Link : https://www.google.com/fonts/specimen/Lobster
SIL Open Font Licence 1.1 http://scripts.sil.org/cms/scripts/page.php?site_id=nrsi&id=OFL
...
Bootstrap : 
==================
WpF Flaty built with the most popular front-end framework Bootstrap which released under various licenses (MIT & CC)
...
Off Canvass Menu  :
==========================
WpF Flaty packed with free jQuery mobile menu which is licensed under MIT.

http://www.pixelademo.com/mobile-menu/
License: http://opensource.org/licenses/MIT

FontAwesome : 
========================
WpF Flaty packed with font awesome which released under various licenses (SIL OFL, MIT, CC).
...
Preloader : 
========================
WpF Flaty packed with lazyloader which is released under MIT license.

Link : http://joaopereirawd.github.io/fakeLoader.js/ 
...
UI Search : 
========================
WpF Flaty packed with a free UI search jQuery plugin which is released under MIT license.
...
WpF Flaty integrated HTML5 Shiv (licensed under MIT/GPL v2.0) & Respond (licensed under MIT) for IE compatibility issues.

HTML5 Shiv link: https://github.com/afarkas/html5shiv
...
Respond Link: https://github.com/scottjehl/Respond
Respond License: http://www.opensource.org/licenses/mit-license.php


Slick : 
========================
WpF Flaty packed with a Slick slider jQuery plugin which is opensource & licensed under MIT.
...
FakeLoader:
====================
FakeLoader is licensed under MIT.
